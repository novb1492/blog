class Bezier
{
    ...
    gety(sheepx,pointx,pointy,pointx2,pointy2)
  {
    ...
    for(var i=0;i<this.totalsteps;i++)
    {
      ...
      xyz[0]=bezierPoint(pointx,pointx-this.secondx,pointx2+this.secondx,pointx2,t);
      if(xyz[0]<=sheepx)
      {
        xyz[1]=bezierPoint(pointy,pointy-this.secondy,pointy2+this.secondy,pointy2,t);
        //곡선의x에대한y좌표가져오는것 x와 동일하나 변수만pointy를 넣으면됨
        let tx = bezierTangent(pointx,pointx-this.secondx,pointx2+this.secondx,pointx2,t);
        let ty = bezierTangent(pointy,pointy-this.secondy,pointy2+this.secondy,pointy2,t);
